      ...
      <div className="chat-message-body">
        ...
        <div className="chat-reply-card">
          <div className="chat-reply-head">
            <span className="chat-reply-kicker">Đã tiếp nhận</span>
          ...
          <ul className="chat-summary-grid" aria-label="Tóm tắt yêu cầu">
            {message.highlights.map(item => (
              <li className="chat-summary-item" key={item.label}>
          ...
          <div className="chat-reply-note">
            <i data-lucide="info" aria-hidden="true" />
            <p>{message.note}</p>
          </div>

          <div className="chat-support-row">
            <div className="chat-support-copy">
              <span>Hỗ trợ gấp</span>
...
export default function ChatBubble({
  ...
  return (
    <>
      ...
      <Drawer.Root open={open} direction="bottom" onOpenChange={handleOpenChange} shouldScaleBackground={false} noBodyStyles>
        <Drawer.Portal>
              ...
              <header className="chat-widget-header">
                <div className="chat-widget-brand">
                  ...
                  <div className="chat-widget-title">
                    ...
                    <Drawer.Description className="sr-only">Khung chat hỗ trợ tư vấn và đặt phòng của StayBridge.</Drawer.Description>
