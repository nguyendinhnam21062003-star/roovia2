export const staybridgeData = (() => {
  ...
  const rooms = [
    {
      id: 'la-homestay-da-lat',
      name: 'Lá Homestay Đà Lạt',
      type: 'Homestay',
      city: 'Đà Lạt',
      ...
      description: 'Phòng ấm cúng trên đồi, có ban công nhìn ra vườn thông. Phù hợp cho cặp đôi hoặc khách đi nghỉ ngắn ngày.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 2 ngày',
        smoking: false,
        pets: false
      },
    ...
    {
      id: 'pine-hill-house-da-lat',
      name: 'Pine Hill House',
      type: 'Nhà nguyên căn',
      city: 'Đà Lạt',
      ...
      description: 'Nhà nguyên căn dành cho gia đình hoặc nhóm bạn, có phòng khách rộng, bếp đầy đủ và sân nhỏ để tụ tập.',
      policies: {
        checkIn: '14:00',
        checkOut: '11:30',
        cancellation: 'Miễn phí trước 3 ngày',
        smoking: false,
        pets: true
      },
    ...
    {
      id: 'sea-breeze-apartment-da-nang',
      ...
      description: 'Căn hộ hai phòng ngủ gần biển Mỹ Khê, có ban công thoáng và hồ bơi chung. Phù hợp cho kỳ nghỉ dài ngày.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 2 ngày',
    ...
    },
    {
      ...
      description: 'Phòng riêng gọn gàng gần biển, phù hợp cho khách công tác hoặc cặp đôi. Tầng trệt có khu tiếp khách chung và quầy hỗ trợ du lịch.',
      policies: {
        checkIn: '13:30',
        checkOut: '11:30',
        cancellation: 'Miễn phí trước 1 ngày',
        smoking: false,
        pets: false
      },
    ...
    {
      id: 'lantern-riverside-hoi-an',
      name: 'Lantern Riverside Villa',
      type: 'Homestay',
      city: 'Hội An',
      ...
      description: 'Không gian nghỉ dưỡng lấy cảm hứng từ Hội An, có hồ bơi nhỏ, khu vườn và xe đạp miễn phí. Yên tĩnh nhưng vẫn tiện ra phố cổ.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 2 ngày',
    ...
    },
    {
      ...
      description: 'Khách sạn boutique gần phố cổ, có hồ bơi trong sân và lễ tân phục vụ 24/7. Phòng cách âm tốt, phù hợp nghỉ cuối tuần.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 3 ngày',
    ...
    {
      id: 'hanoi-lotus-studio',
      name: 'Hanoi Lotus Studio',
      type: 'Căn hộ',
      city: 'Hà Nội',
      ...
      description: 'Studio riêng tư ở trung tâm, có bếp nhỏ, bàn làm việc và ban công. Phù hợp cho chuyến đi ngắn ngày ở khu phố cổ.',
      policies: {
        checkIn: '14:00',
        checkOut: '11:00',
        cancellation: 'Miễn phí trước 2 ngày',
    ...
    {
      id: 'west-lake-family-home',
      name: 'West Lake Family Home',
      type: 'Nhà nguyên căn',
      city: 'Hà Nội',
      ...
      description: 'Ngôi nhà nhiều tầng dành cho nhóm đông người, có khu sinh hoạt chung rộng và sân thượng nhìn ra Hồ Tây.',
      policies: {
        checkIn: '15:00',
        checkOut: '11:00',
        cancellation: 'Miễn phí trước 4 ngày',
        smoking: false,
        pets: true
      },
    ...
    {
      id: 'coral-bay-nha-trang',
      name: 'Coral Bay Hotel Nha Trang',
      type: 'Khách sạn',
      city: 'Nha Trang',
      address: 'Lộc Thọ, Nha Trang, Khánh Hòa',
      price: 860000,
      oldPrice: 980000,
      rating: 4.7,
      reviewCount: 256,
      ...
      discount: 12,
      amenities: ['Wi-Fi miễn phí', 'Máy lạnh', 'Hồ bơi', 'Ban công', 'Chỗ đỗ xe'],
      description: 'Khách sạn gần biển Trần Phú, có hồ bơi trên cao và phòng nhìn ra thành phố. Phù hợp cho gia đình nhỏ và khách nghỉ dưỡng.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 2 ngày',
    ...
    {
      id: 'ocean-view-serviced-apartment',
      name: 'Ocean View Serviced Apartment',
      type: 'Căn hộ',
      city: 'Nha Trang',
      address: 'Vĩnh Hải, Nha Trang, Khánh Hòa',
      price: 720000,
      oldPrice: 800000,
      rating: 4.6,
      reviewCount: 109,
      ...
      description: 'Căn hộ dịch vụ đầy đủ tiện nghi, có bếp và cửa sổ lớn nhìn ra biển. Phù hợp cho gia đình cần sự riêng tư.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 2 ngày',
    ...
    {
      id: 'bay-view-halong-retreat',
      name: 'Bay View Hạ Long Retreat',
      type: 'Homestay',
      city: 'Hạ Long',
      ...
      discount: 10,
      amenities: ['Wi-Fi miễn phí', 'Máy lạnh', 'Bếp', 'Hồ bơi', 'Ban công', 'Chỗ đỗ xe'],
      description: 'Căn hộ nghỉ dưỡng có ban công nhìn vịnh, bếp riêng và hồ bơi của tòa nhà. Thuận tiện đi khu vui chơi Bãi Cháy.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 3 ngày',
    ...
    {
      id: 'sunrise-motel-halong',
      name: 'Sunrise Motel Hạ Long',
      type: 'Nhà nghỉ',
      city: 'Hạ Long',
      ...
      description: 'Nhà nghỉ sạch sẽ, giá hợp lý và có chỗ đỗ xe. Phòng trang bị các tiện nghi cơ bản, phù hợp cho chuyến đi ngắn.',
      policies: {
        checkIn: '13:00',
        checkOut: '11:30',
        cancellation: 'Miễn phí trước 1 ngày',
    ...
    },
    {
      ...
      description: 'Căn loft hiện đại ở trung tâm, có hồ bơi và phòng gym chung. Phù hợp cho khách công tác và người thích nhịp sống thành phố.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 2 ngày',
    ...
    {
      id: 'garden-room-thao-dien',
      name: 'Garden Room Thảo Điền',
      type: 'Phòng riêng',
      city: 'TP. Hồ Chí Minh',
      ...
      description: 'Phòng riêng trong ngôi nhà có sân vườn, gần nhiều quán cà phê và nhà hàng ở Thảo Điền. Có bếp chung và nhận thú cưng nhỏ.',
      policies: {
        checkIn: '14:00',
        checkOut: '12:00',
        cancellation: 'Miễn phí trước 2 ngày',
  ...
  const reviews = [
    {
      ...
      date: '12/05/2026',
      rating: 5,
      text: 'Phòng sạch sẽ, đúng như hình. Tư vấn nhanh và hướng dẫn nhận phòng rất rõ ràng.',
      avatar: 'MA'
    },
    {
      name: 'Trần Quốc Huy',
      date: '28/04/2026',
      rating: 5,
      text: 'Vị trí thuận tiện, không gian yên tĩnh. Tôi thích ban công và cách bố trí phòng.',
      avatar: 'QH'
    },
    {
      name: 'Lê Hoàng Ngân',
      date: '09/04/2026',
      rating: 4,
      text: 'Giá hợp lý so với vị trí. Tiện nghi đầy đủ, phù hợp cho chuyến đi ngắn.',
      avatar: 'HN'
    },
    {
      name: 'Phạm Gia Bảo',
      date: '22/03/2026',
      rating: 5,
      text: 'Quá trình liên hệ nhanh gọn, chủ nhà thân thiện. Tôi sẽ quay lại trong chuyến đi sau.',
      avatar: 'GB'
    }
  ];
...
export const { rooms, destinations, reviews } = staybridgeData;
